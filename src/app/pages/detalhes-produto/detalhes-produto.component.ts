...
export class DetalhesProdutoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    alert(`Token: ${token}`); // Verifique se o token está sendo recuperado corretamente
    ...
    this.route.paramMap.pipe(
      switchMap(params => {
        ...
        if (id) {
          ...
          return this.produtoService.getProdutoById(id, token!); // Passe o token para o serviço
        } else {
